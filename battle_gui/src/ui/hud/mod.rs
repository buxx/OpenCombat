...
use battle_core::config::{UI_SPRITE_SHEET_HEIGHT, UI_SPRITE_SHEET_WIDTH};
...
pub const BACKGROUND_LEFT_HEIGHT: f32 = 400.;
...
pub const BACKGROUND_CENTER_HEIGHT: f32 = 400.;
...
pub const BACKGROUND_RIGHT_HEIGHT: f32 = 400.;
